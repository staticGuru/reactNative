...
const MentionInput = _a => {
  ...
  const {plainText, parts} = react_1.useMemo(
    () => utils_1.parseValue(value, partTypes),
    [value, partTypes],
  );
  ...
  const onSuggestionPress = mentionType => suggestion => {
    const newValue = utils_1.generateValueWithAddedSuggestion(
      parts,
      mentionType,
      plainText,
      selection,
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      Object.assign({multiline: true}, textInputProps, {
                  ...
                  key: `${index}-${
                    (_a =
                      data === null || data === void 0
                        ? void 0
                        : data.trigger) !== null && _a !== void 0
                      ? _a
                      : 'pattern'
                  }`,
                  style:
                    (_b = partType.textStyle) !== null && _b !== void 0
                      ? _b
                      : utils_1.defaultMentionTextStyle,
                },
                text,
              )
            : react_1.default.createElement(
